...
insert into rooms (id, name, base_ticket_price, min_participants, max_participants, min_age)
values (1, 'Pharaoh''s Tomb', 10.00, 5, 7, 12),
       (2, 'Enigma Code', 15.00, 6, 9, 15),
       (3, 'Pirate Ship', 20.00, 4, 6, null),
       (4, 'Nuclear Silo', 30.00, 5, 8, 15);

insert into reservations (id, room_id, total_price, date_from, date_to, date_cancelled)
...
insert into guests (id, email, first_name, last_name, phone_number, date_birth, discount_percent)
...
insert into tickets (id, price, reservation_id, guest_id, guest_allowed_to_cancel)
